...
const criaListaCharacter = (data) => {
    ...
    data.results.forEach(character => {
        ...
        <div class="card-body">
            <h3 class="text-primary text-white text-center">${character.name}</h3>
        </div>
    `;
    ...
    <div class="card-body">
        ...
        <article>
            <ul class="list-group">
                ...
                <li class="list-group-item">${character.type}</li>
...
const novoItemPagination = (url, index) => {
    ...
    liItem.innerHTML = `<a onclick="prevItemPagination('${url}')" class="page-link" href="#">${index}</a>`;
    return liItem;
}

const prevItemPagination = (url) => {
